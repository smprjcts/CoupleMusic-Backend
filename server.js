...
app.use(cors({ origin: ["http://localhost:5173", "https://admin.socket.io","https://smprjcts.github.io","https://smprjcts.github.io/CM/"], credentials: true}));
...
const io = new Server(server, {
  cors: { origin: ["http://localhost:5173", "https://admin.socket.io","https://smprjcts.github.io","https://smprjcts.github.io/CM/"] , credentials: true} // Allow your Vite app
});
